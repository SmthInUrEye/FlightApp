...
public class FlightMapper {
    ...
    public FlightEntity toEntity(Flight flight) {
        ...
        List<SegmentEntity> segmentEntities = flight.getSegments().stream()
    ...
    public FlightDTO toDTO(Flight flight) {
        List<SegmentDTO> segmentDTOs = flight.getSegments().stream()
    ...
    public FlightDTO toDTO(FlightEntity entity) {
        List<SegmentDTO> segmentDTOs = entity.getSegments().stream()
         .map(this::toSegmentDTO)
         .collect(Collectors.toList());
    ...
    public FlightEntity toEntity(FlightDTO dto) {
        ...
        List<SegmentEntity> segmentEntities = dto.getSegments().stream()
         .map(this::toSegmentEntity)
         .collect(Collectors.toList());
        entity.setSegments(segmentEntities);
